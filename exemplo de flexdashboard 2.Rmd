...
selectInput("rubricas_id","Escolha a rubrica", choices = c("III. RECEITA LÍQUIDA  (I-II)",
                        "IV. DESPESA TOTAL",
                        "V. FUNDO SOBERANO DO BRASIL",
                        "VI. PRIMÁRIO GOVERNO CENTRAL"),selected = "VI. PRIMÁRIO GOVERNO CENTRAL",  multiple = TRUE)
```
...
renderPlot({
  ...
  filter(Rubrica %in% input$rubricas_id) %>%
